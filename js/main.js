const DEFAULT_STRINGS = {
    ...
    "gallery.legal":
      "Kuvat: Wikimedia Commons (lisenssit alla). Voit korvata ne asiakkaan omilla valokuvilla.",
  ...
  sv: {
    ...
    "gallery.legal":
      "Bilder: Wikimedia Commons (licenser nedan). De kan bytas ut mot kundens egna foton.",
  ...
  en: {
    ...
    "gallery.legal":
      "Photos: Wikimedia Commons (licences below). Replace with the client’s own photography if preferred.",
